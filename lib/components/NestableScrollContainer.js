...
var AnimatedScrollView = react_native_reanimated_1.default.createAnimatedComponent(
...
function NestableScrollContainerInner(props) {
  var _a = nestableScrollContainerContext_1.useNestableScrollContainerContext(),
    ...
    scrollViewSize = _a.scrollViewSize,
    scrollableRef = _a.scrollableRef,
    outerScrollEnabled = _a.outerScrollEnabled;
  var onScroll = react_1.useMemo(function () {
    return react_native_reanimated_1.default.event([
      {
        nativeEvent: function (_a) {
          ...
          return react_native_reanimated_1.block([
            react_native_reanimated_1.set(outerScrollOffset, contentOffset.y),
          ]);
        },
      },
    ]);
...
function NestableScrollContainer(props) {
  return react_1.default.createElement(
    nestableScrollContainerContext_1.NestableScrollContainerProvider,
    null,
    react_1.default.createElement(
