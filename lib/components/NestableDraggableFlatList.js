...
function NestableDraggableFlatListInner(props, ref) {
  var _this = this;
  var hasSuppressedWarnings = react_1.useRef(false);
  ...
  var _a = nestableScrollContainerContext_1.useNestableScrollContainerContext(),
    containerRef = _a.containerRef,
    outerScrollOffset = _a.outerScrollOffset,
    setOuterScrollEnabled = _a.setOuterScrollEnabled;
  var listVerticalOffset = react_1.useMemo(function () {
    return new react_native_reanimated_1.default.Value(0);
  }, []);
  var viewRef = react_1.useRef(null);
  var _b = react_1.useState({}),
    animVals = _b[0],
    setAnimVals = _b[1];
  useNestedAutoScroll_1.useNestedAutoScroll(animVals);
  var onListContainerLayout = function () {
    return __awaiter(_this, void 0, void 0, function () {
      var viewNode, nodeHandle, onSuccess, onFail;
      return __generator(this, function (_a) {
        viewNode = viewRef.current;
        nodeHandle = react_native_1.findNodeHandle(containerRef.current);
  ...
  return react_1.default.createElement(
    ...
    { ref: viewRef, onLayout: onListContainerLayout },
    react_1.default.createElement(
      DraggableFlatList_1.default,
      __assign(
        {
          ref: ref,
        ...
        props,
        {
          ...
          onDragBegin: function () {
            ...
            (_a = props.onDragBegin) === null || _a === void 0
              ? void 0
              : _a.call.apply(_a, __spreadArray([props], args));
          },
          onDragEnd: function () {
            var _a;
            var args = [];
            ...
            (_a = props.onDragEnd) === null || _a === void 0
              ? void 0
              : _a.call.apply(_a, __spreadArray([props], args));
          ...
          onAnimValInit: function (animVals) {
            var _a;
            setAnimVals(
              __assign(__assign({}, animVals), {
                hoverAnim: react_native_reanimated_1.add(
                  animVals.hoverAnim,
                  listVerticalOffset
                ),
              })
            );
            (_a = props.onAnimValInit) === null || _a === void 0
              ? void 0
              : _a.call(props, animVals);
          },
        }
      )
    )
...
exports.NestableDraggableFlatList = react_1.default.forwardRef(
